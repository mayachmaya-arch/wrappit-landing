...
export default function Hero() {
  ...
  return (
    <section
      id="top"
      aria-label="פתיח"
      className="relative flex min-h-[520px] flex-col items-end justify-end gap-10 pt-16 pb-16 sm:pt-24 sm:pb-20"
    >
      <div className="flex flex-col items-end text-cloud">
        <div
        ...
        >
          {ROTATING_PHRASES.map((phrase, index) => (
            <span
              ...
              className="absolute inset-0 flex items-center justify-end transition-opacity duration-700 ease-in-out"
